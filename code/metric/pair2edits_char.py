...
src_path = 'data/src.txt'  # 不带sid的source
tgt_path = 'data/trg.txt'  # 不带sid的target
# sid_path = sys.argv[3] # sid或带sid的source
# pair2edits_char.py flacgec/src.txt flacgec/trg.txt > flacgec/ref.txt
# perl evaluation.pl flacgec/gector-out.txt flacgec/gector-report.txt flacgec/ref.txt 
